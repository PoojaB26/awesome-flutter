...
<p align="center">
  <a href="https://stackoverflow.com/questions/tagged/flutter?sort=votes">
    <img alt="StackOverflow" src="https://img.shields.io/badge/StackOverflow-8343-orange.svg" />
  </a>
  <a href="https://github.com/search?q=flutter+language%3Adart&type=Repositories">
    <img alt="Github Repositories" src="https://img.shields.io/badge/Repos-13299-brightgreen.svg" />
  </a>
...
- [Pooja's Guide to Flutterverse](https://medium.com/flutter-community/i-want-to-learn-flutter-how-to-start-ffb4145f9b26) [1.2K claps👏] - A step by step guide for learning Flutter for super beginners by [Pooja Bhaumik](https://twitter.com/pblead26).
...
- [Firebase](https://www.youtube.com/watch?v=p4yLzYwy_4g) [427👍] - Firebase live coding.
...
- [Rendering Engine Tutorial](https://medium.com/saugo360/flutters-rendering-engine-a-tutorial-part-1-e9eff68b825d) [420 claps👏] - Flutter's Rendering Engine: A Tutorial by [AbdulRahman AlHamali](https://github.com/AbdulRahmanAlHamali/).
...
- [Tensor Programming](https://www.youtube.com/watch?v=WwhyaqNtNQY&list=PLJbE2Yu2zumDqr_-hqpAN0nIr6m14TAsd) [71🎬] - Very rich content by [Tensor Programming](http://tensor-programming.com/).
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) [1632⭐] - Simple basic isolated apps for devs by [Nishant Srivastava](https://github.com/nisrulz).
...
- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) [335⭐] - GridView with tiles of variable sizes by [Romain Rastel](https://github.com/letsar).
...
- [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation) [323⭐] - Smooth animation from login to home by [Ruchika Gupta](https://github.com/geekruchika).
...
- [Snaplist](https://github.com/ariedov/flutter_snaplist) [73⭐] - Create snappable list views by [David Leibovych](https://github.com/ariedov).
...
- [Folding Cell](https://github.com/faob-dev/folding_cell) [50⭐] - Fold your widget by [Faob](https://github.com/faob-dev).
...
- [Wave](https://github.com/i-protoss/wave) [31⭐] - Displaying some waves with custom color, duration, floating and blur effects by [RockerFlower](https://github.com/RockerFlower).
...
- [Carousel Slider](https://github.com/serenader2014/flutter_carousel_slider) [124⭐] - Carousel slider widget, support infinite scroll and custom child widget by [serenader](https://github.com/serenader2014).
...
- [Photo View](https://github.com/renancaraujo/photo_view) [215⭐] - Scalable image view with loading placeholder by [Renan C. Araújo](https://github.com/renancaraujo).
- [SVG](https://github.com/dnfield/flutter_svg) [190⭐] - SVG parsing, rendering, and widget library by [Dan Field](https://github.com/dnfield).
...
- [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) [251⭐] - Show images from the internet and keep them in the cache directory by.
- [Multi Image Picker](https://github.com/Sh1d0w/multi_image_picker) [88⭐] - Display multi image picker by [Radoslav Vitanov](https://github.com/Sh1d0w).
...
- [Mapbox GL](https://github.com/mapbox/flutter-mapbox-gl) [154⭐] - Interactive, customizable vector maps by Mapbox.
...
- [Charts](https://github.com/google/charts) [394⭐] - By Google Charts Team.
...
- [FCharts](https://github.com/thekeenant/fcharts) [198⭐] - Beautiful, responsive, animated charts by [Keenan Thompson](https://keenant.com).

### Navigation

- [Fluro](https://github.com/goposse/fluro) [614⭐] - The brightest, hippest, coolest router for Flutter with Navigation, wildcard, query, transitions by [Posse](http://goposse.com).
...
- [Login](https://github.com/AppleEducate/flutter_login) [198⭐] - FaceID, TouchID, and Fingerprint Reader by [Rody Davis](http://appleeducate.com).
...
- [Markdown](https://github.com/flutter/flutter_markdown) [150⭐] - Markdown renderer for Flutter. It supports the original format, but no inline html.
...
- [Zefyr](https://github.com/memspace/zefyr) [296⭐] - Soft and gentle rich text editing by [Memspace](https://github.com/memspace/zefyr).
...
- [Audio Plugin](https://github.com/rxlabz/audioplayer) [182⭐] - Beta by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) [251⭐] - WebRTC plugin for iOS/Android by [CloudWebRtc](https://github.com/cloudwebrtc).
- [Chewie](https://github.com/brianegan/chewie) [190⭐] - Provides low-level access to video playback by [Brian Egan](https://github.com/brianegan).
...
- [Movie Details](https://github.com/FlutterRocks/movie-details-ui) [179⭐] - Movie details page by [Iiro Krankka](https://github.com/roughike).
- [Mates](https://github.com/CodemateLtd/FlutterMates) [243⭐] - How to load profiles from the randomuser.me API and a nice profile details page by [Iiro Krankka](https://github.com/roughike).
...
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) [1618⭐] - TODO application ready to go with different flavors : Vanilla, Redux, built_redux by [Brian Egan](https://github.com/brianegan).
...
- [UI Challenges](https://github.com/tomialagbe/flutter_ui_challenges) [482⭐] - Profile, Travel, Food App by [Tomi Alagbe](https://github.com/tomialagbe).
...
- [Card Swipe Animation](https://github.com/geekruchika/FlutterCardSwipe) [140⭐] - Swipe cards template by [Ruchika Gupta](https://github.com/geekruchika).
- [UI Kit](https://github.com/iampawan/Flutter-UI-Kit) [1604⭐] - Collection of useful UIs in a UIKit by [Pawan Kumar](https://github.com/iampawan).
- [Book](https://github.com/putraxor/flutter-book-app) [99⭐] - Bookshelf by [Ardiansyah Putra](https://github.com/putraxor).
...
- [DrawApp](https://github.com/SnakeyHips/drawapp) [35⭐] - Sample Drawing App to demonstrate how to allow user to draw onto canvas with color picker and brush thickness slider by [Jake Gough](https://github.com/SnakeyHips).
...
- [WebView](https://github.com/dart-flitter/flutter_webview_plugin) [395⭐] - Render web content by [Hadrien Lejard](https://twitter.com/HadrienLejard).
...
- [Downloader](https://github.com/hnvn/flutter_downloader) [91⭐] - Create and manage download tasks by [HungHD](https://github.com/hnvn).
- [InAppBrowser](https://github.com/pichillilorenzo/flutter_inappbrowser) [116⭐] - Add inline WebView widgets or open an in-app browser window by [Lorenzo Pichilli](https://github.com/pichillilorenzo).
...
- [Aeyrium Sensor](https://github.com/aeyrium/aeyrium-sensor) [16⭐] - A plugin which provide easy access to the Pitch and Roll on Android and iOS devices by [Diego Velásquez](https://github.com/aeyrium).
- [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) [13⭐] - Native file explorer to load absolute file path by [Miguel Ruivo](https://github.com/miguelpruivo).
...
- [Blue](https://github.com/pauldemarco/flutter_blue) [335⭐] - Bluetooth by [Paul DeMarco](https://github.com/pauldemarco).
- [Beacons](https://github.com/loup-v/beacons) [16⭐] - Flutter beacons plugin by [Loup](http://intheloup.io).
...
- [Google Mobile Vision](https://github.com/edufolly/flutter_mobile_vision) [139⭐] - Google Mobile Vision by [Eduardo Folly](https://github.com/edufolly).
- [Dialogflow](https://github.com/VictorRancesCode/flutter_dialogflow) [35⭐] - Plugin to easily integrate with dialogflow by [Victor Rances](https://github.com/VictorRancesCode/).
...
- [MLKit](https://github.com/azihsoyn/flutter_mlkit) [121⭐] - Firebase Machine Learning Kit by [Naoya Yoshizawa](https://github.com/azihsoyn).
...
- [Bloc](https://github.com/felangel/bloc) [194⭐] - Collection of packages that help implement the BLoC design pattern by [Felix Angelov](https://github.com/felangel).
...
- [Redux](https://github.com/brianegan/flutter_redux) [474⭐] - Built to work with [redux.dart](https://github.com/johnpryan/redux.dart), utilities that allow you to easily consume a Redux Store to build Widgets.
- [Dartea](https://github.com/p69/dartea) [52⭐] - Model View Update inspired by TEA from ELM by [Shilyagov P](https://github.com/p69).
- [Inject](https://github.com/google/inject.dart) [302⭐] - Compile-time dependency injection for Dart and Flutter by Google.
- [Flutter_flux](https://github.com/google/flutter_flux) [259⭐] - Implementation of the Flux framework by Google.

### Data

- [Graphql_flutter](https://github.com/zino-app/graphql-flutter) [423⭐] - Implementation of the GraphQL spec by [Zino App B.V.](https://github.com/zino-app).

### Animation

- [Sequence Animation](https://github.com/Norbert515/flutter_sequence_animation) [101⭐] - Composite staggered animations by [Norbert Kozsir](https://twitter.com/norbertkozsir).
- [SpinKit](https://github.com/jogboms/flutter_spinkit) [415⭐] - Animated loading indicators by [Jeremiah Ogbomo](https://twitter.com/jogboms).
- [Villains](https://github.com/Norbert515/flutter_villains) [119⭐] - Page transition animations by [Norbert Kozsir](https://twitter.com/norbertkozsir).
- [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) [158⭐] - A collection of cool text animations by [Ayush Agarwal](https://github.com/aagarwal1012/).

### Game Engine

- [Flame](https://github.com/luanpotter/flame) [543⭐] - Minimalist game engine by [Luan Nico](https://github.com/luanpotter).
...
- [Cache Manager](https://github.com/renefloor/flutter_cache_manager) [86⭐] - Generic cache manager by [Rene Floor](https://github.com/renefloor).

## Open Source Apps

- [FriendlyChat](https://github.com/flutter/friendlychat-flutter) [188⭐] - Offline/Firebase chat by a team of Googlers.
- [Meme Chat](https://github.com/efortuna/memechat) [306⭐] - Chat app on Flutter, using Firebase, Google Sign In, and device camera integration by a team of Googlers.
- [Flitter](https://github.com/dart-flitter/flitter) [130⭐] - Glitter app by [Hadrien Lejard](https://twitter.com/HadrienLejard) and [Kevin Segaud](https://twitter.com/kevin_segaud). It uses Redux and Jaguar.
- [Lime](https://github.com/fablue/lime-flutter) [194⭐] - Lime social network by Sebastian Sellmair.
- [Planets](https://github.com/sergiandreplace/flutter_planets_tutorial) [314⭐] - Planet exploration that demonstrate rich UI by [Sergi Martínez](http://sergiandreplace.com).
- [NewsBuzz](https://github.com/theankurkedia/NewsBuzz) [263⭐] - Firebase backed news reader using News API by [Ankur Kedia](https://github.com/theankurkedia).
- [DroidKaigi2018-flutter](https://github.com/konifar/droidkaigi2018-flutter) [347⭐] - Unofficial conference app for DroidKaigi 2018 Tokyo by [konifar](https://github.com/konifar).
- [Music Player](https://github.com/iampawan/Flutter-Music-Player) [409⭐] - Full featured music player by [Pawan Kumar](https://about.me/imthepk).
- [WhatTodo](https://github.com/burhanrashid52/WhatTodo) [303⭐] - Todoist like UI by [Burhanuddin Rashid](https://about.me/burhanrashid52).
- [FlutterGram](https://github.com/mdanics/fluttergram) [330⭐] - Complete Instagram based on Firestore & Google Functions by [MDanics](https://github.com/mdanics).
- [BookSearch](https://github.com/Norbert515/BookSearch) [208⭐] - Digital BookShelf for your reading progress by [Norbert515](https://github.com/Norbert515).
- [Cinematic](https://github.com/aaronoe/FlutterCinematic) [360⭐] - UI for Movie DB Public API by [Aaron Oertel](https://github.com/aaronoe).
...
- [Trace](https://github.com/trentpiercy/trace) [148⭐] - Modern and powerful crypto portfolio & market explorer by [Trent Piercy](https://github.com/trentpiercy).
- [Taskist](https://github.com/huextrat/Taskist) [93⭐] - Taskist is a ToDo List app for Task Management by [Hugo EXTRAT](https://github.com/huextrat).
- [Tourism](https://github.com/bluemix/tourism-demo) [49⭐] - Tourism app based on redux w/ animations & i18n by [blueMix](https://github.com/bluemix/tourism-demo).
...
- [Deer](https://github.com/aleksanderwozniak/deer) [44⭐] - Minimalist Todo Planner built using BLoC pattern by [Aleksander Woźniak](https://github.com/aleksanderwozniak).

### Block / Angular / PWA

- [InKino](https://github.com/roughike/inKino) [1538⭐] - Movie app with flutter_redux, animations and unit tests by [Iiro Krankka](https://github.com/roughike).

### Games

- [Flip](https://github.com/RedBrogdon/flutterflip) [71⭐] - Reversi game by [Andrew Brogdon](https://github.com/RedBrogdon).
- [2048](https://github.com/anuranBarman/2048) [31⭐] - 2048 game by [Anuran Barman](https://github.com/anuranBarman).
- [TRex](https://github.com/renancaraujo/trex-flame) [49⭐] - Port of the famous Chrome's Trex game by [Renan C. Araújo](https://github.com/renancaraujo).
- [Crush](https://github.com/boeledi/flutter_crush) [75⭐] - How to build a Math-3 game, like Candy Crush, Bejeweled by [Didier Boelens](https://didierboelens.com).
...
- [Desktop Embedding](https://github.com/google/flutter-desktop-embedding) [2479⭐] - Desktop implementations of the Flutter embedding API by Google.
- [Golang Desktop Embedder](https://github.com/Drakirus/go-flutter-desktop-embedder) [424⭐] - Golang embedder for desktop by [Pierre Champion](https://github.com/Drakirus).
